...
- `src/test/java/io/freitas/empcard`: JUnit/Spring Boot integration tests.
...
- `./mvnw spring-boot:run -Pprod`: run with production profile settings.
...
- Keep Spring layer names explicit (`*Controller`, `*Service`, `*Repository`).
